...
public sealed class Orderdo : EqualObject
{
    /// <summary>
    /// 获取或者设置打印标志
    /// </summary>
    ...
    /// 获取或者设置物资出库单标识
    /// </summary>
    [Column("hrpckdid", Order = 165)]
    public long? HrpCkdId { get; set; }
    /// <summary>
    /// 获取或者设置库房代码
    /// </summary>
    [String32]
    [Column("pharmdept", Order = 166)]
    public string Pharmdept { get; set; }
    /// <summary>
    /// 获取或者设置执行确认状态
    /// </summary>
    [Column("zxqrzt", Order = 167)]
    public int? Zxqrzt { get; set; }
    /// <summary>
    /// 获取或者设置执行确认用户代码
    /// </summary>
    [String32]
    [Column("zxqryhid", Order = 168)]
    public string ZxqryhId { get; set; }
    /// <summary>
    /// 获取或者设置执行确认用户
    /// </summary>
    [String64]
    [Column("zxqryh", Order = 169)]
    public string Zxqryh { get; set; }
    /// <summary>
    /// 获取或者设置执行确认日期
    /// </summary>
    [Column("zxqrrq", Order = 170)]
    public DateTime? Zxqrrq { get; set; }
    /// <summary>
    /// 获取或者设置执行人代码
    /// </summary>
    [MaxLength(32)]
    [Column("zxrid", Order = 171)]
    public string Zxrid { get; set; }
    /// <summary>
    /// 获取或者设置执行人
    /// </summary>
    [MaxLength(64)]
    [Column("zxr", Order = 172)]
    public string Zxr { get; set; }
    /// <summary>
    /// 获取或者设置执行日期
    /// </summary>
    [Column("zxrq", Order = 173)]
    public DateTime? Zxrq { get; set; }
    /// <summary>
    /// 获取或者设置执行病区代码
    /// </summary>
    [MaxLength(32)]
    [Column("zxbqid", Order = 174)]
    public string Zxbqid { get; set; }
    /// <summary>
    /// 获取或者设置执行病区
    /// </summary>
    [MaxLength(64)]
    [Column("zxbq", Order = 175)]
